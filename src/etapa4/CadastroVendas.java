...
public class CadastroVendas extends javax.swing.JFrame {
    ...
    public CadastroVendas() {
        ...
        comboProdVendas.addActionListener(evt -> {
    Produto p = (Produto) comboProdVendas.getSelectedItem();
    ...
    private void btnCadastrarVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarVendaActionPerformed
     ...
     try {
        ...
        Produto produto = (Produto) comboProdVendas.getSelectedItem();
        ...
        if (promo != null) {
            double desconto = promo.getPorcentagemDesc();
            valorTotal = valorTotal - (valorTotal * (desconto / 100));
        }

        
        ClienteDAO daoCliente = new ClienteDAO();
        Cliente cliente = daoCliente.pegarUltimoCliente();
    ...
    private javax.swing.JComboBox<Produto> comboProdVendas;
