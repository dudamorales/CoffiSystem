...
public class CadastroProd extends javax.swing.JFrame {
    ...
    public CadastroProd() {
        ...
        for (Fornecedor f : fornDAO.listar()) {
            comboFornec.addItem(f);
        }
    }
    ...
    private void btnCadastrarProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarProdActionPerformed
        ...
        if (comboCategoria.getSelectedItem() == null || comboFornec.getSelectedItem() == null) {
        JOptionPane.showMessageDialog(null, "Cadastre categoria e fornecedor primeiro!");
        return;
        }
        
        try {
            
        if (txtNomeProd.getText().isEmpty() || txtValorProd.getText().isEmpty()) {
        ...
        Fornecedor forn = (Fornecedor) comboFornec.getSelectedItem();
    ...
    private javax.swing.JComboBox<Fornecedor> comboFornec;
